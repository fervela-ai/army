...
import { SEATS } from '../engine/src/board.mjs?v=196';
import { legalMoves as calcLegalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=196';
import { GAME_WS } from './config.js?v=196';
import { ensureAccount } from './account.js?v=196';
