...
// 立刻轉視角會讓人看不到自己剛剛走了什麼。
import { SEATS } from '../engine/src/board.mjs?v=136';
import { randomLayout } from '../engine/src/random-layout.mjs?v=136';
import { localSession } from './session.js?v=136';
import { RECORD_ENDPOINT, AI_VERSION } from './config.js?v=136';
import { buildGuide } from './guide.js?v=136';
import { checkAchievements, ACHIEVEMENTS, unlockedIds } from './achievements.js?v=136';
import { createBoardView } from './board.js?v=136';
import { SFX, setEnabled, VARIANTS, getChoice, setVariant, preview } from './sound.js?v=136';
...
// 值從自己的 import URL 取（?v=136），bump-ui-version.sh 一改就跟著動，不會忘記同步。
