...
import { gameStats } from '../engine/src/game-stats.mjs?v=193';
import { legalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=193';
import {
  createRoom, join, claimSeat, startSetup, submitLayout, maybeStartGame,
  play, stateForPlayer,
} from '../engine/src/room.mjs?v=193';
import { doctrineLayout } from '../engine/ai/doctrine-layout.mjs?v=193';
import { VALUE } from '../engine/ai/lookahead.mjs?v=193';
import { chooseMove, createMemory, observe, noteOwnMove } from '../engine/ai/ai.mjs?v=193';
import { searchMove } from '../engine/ai/search.mjs?v=193';
