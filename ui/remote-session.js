...
import { SEATS } from '../engine/src/board.mjs?v=204';
import { legalMoves as calcLegalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=204';
import { GAME_WS } from './config.js?v=204';
import { ensureAccount } from './account.js?v=204';
