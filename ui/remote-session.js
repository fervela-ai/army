...
import { SEATS } from '../engine/src/board.mjs?v=197';
import { legalMoves as calcLegalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=197';
import { GAME_WS } from './config.js?v=197';
import { ensureAccount } from './account.js?v=197';
