...
import { SEATS } from '../engine/src/board.mjs?v=200';
import { legalMoves as calcLegalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=200';
import { GAME_WS } from './config.js?v=200';
import { ensureAccount } from './account.js?v=200';
