...
// 立刻轉視角會讓人看不到自己剛剛走了什麼。
import { SEATS } from '../engine/src/board.mjs?v=104';
import { randomLayout } from '../engine/src/random-layout.mjs?v=104';
import { localSession } from './session.js?v=104';
import { RECORD_ENDPOINT, AI_VERSION } from './config.js?v=104';
import { buildGuide } from './guide.js?v=104';
import { checkAchievements, ACHIEVEMENTS, unlockedIds } from './achievements.js?v=104';
import { createBoardView } from './board.js?v=104';
import { SFX, setEnabled, VARIANTS, getChoice, setVariant, preview } from './sound.js?v=104';
