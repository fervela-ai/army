...
import { SEATS } from '../engine/src/board.mjs?v=206';
import { legalMoves as calcLegalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=206';
import { GAME_WS } from './config.js?v=206';
import { ensureAccount } from './account.js?v=206';
