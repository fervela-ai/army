...
import { referenceLayout } from '../engine/ai/reference-layout.mjs?v=186';
import { legalMoves, movePath } from '../engine/src/rules.mjs?v=186';
import { BOARD } from '../engine/src/board.mjs?v=186';
