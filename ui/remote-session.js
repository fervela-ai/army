...
import { SEATS } from '../engine/src/board.mjs?v=198';
import { legalMoves as calcLegalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=198';
import { GAME_WS } from './config.js?v=198';
import { ensureAccount } from './account.js?v=198';
