...
import { SEATS } from '../engine/src/board.mjs?v=192';
import { legalMoves as calcLegalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=192';
import { GAME_WS } from './config.js?v=192';
import { ensureAccount } from './account.js?v=192';
