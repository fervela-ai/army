...
import { SEATS } from '../engine/src/board.mjs?v=209';
import { legalMoves as calcLegalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=209';
import { GAME_WS } from './config.js?v=209';
import { ensureAccount } from './account.js?v=209';
