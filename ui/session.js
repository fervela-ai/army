...
import { SEATS, TEAM_OF } from '../engine/src/board.mjs?v=183';
import { legalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=183';
import {
  createRoom, join, claimSeat, startSetup, submitLayout, maybeStartGame,
  play, stateForPlayer,
} from '../engine/src/room.mjs?v=183';
import { doctrineLayout } from '../engine/ai/doctrine-layout.mjs?v=183';
import { VALUE } from '../engine/ai/lookahead.mjs?v=183';
import { chooseMove, createMemory, observe, noteOwnMove } from '../engine/ai/ai.mjs?v=183';
import { searchMove } from '../engine/ai/search.mjs?v=183';
