...
import { SEATS } from '../engine/src/board.mjs?v=203';
import { legalMoves as calcLegalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=203';
import { GAME_WS } from './config.js?v=203';
import { ensureAccount } from './account.js?v=203';
