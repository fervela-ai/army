...
// 立刻轉視角會讓人看不到自己剛剛走了什麼。
import { SEATS, TEAM_OF } from '../engine/src/board.mjs?v=193';
import { randomLayout } from '../engine/src/random-layout.mjs?v=193';
import { localSession } from './session.js?v=193';
import { remoteSession } from './remote-session.js?v=193';
import { createRoom, ensureAccount, currentAccount, redeem, rotateRecovery } from './account.js?v=193';
import { RECORD_ENDPOINT, AI_VERSION } from './config.js?v=193';
import { buildGuide } from './guide.js?v=193';
import { checkAchievements, ACHIEVEMENTS, unlockedIds, titleFor, noteGame } from './achievements.js?v=193';
import { createBoardView } from './board.js?v=193';
import { SFX, setEnabled, VARIANTS, getChoice, setVariant, preview } from './sound.js?v=193';
...
// 值從自己的 import URL 取（?v=193），bump-ui-version.sh 一改就跟著動，不會忘記同步。
