...
import { legalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=48';
import {
  createRoom, join, claimSeat, startSetup, submitLayout, maybeStartGame,
  play, stateForPlayer,
} from '../engine/src/room.mjs?v=48';
import { doctrineLayout } from '../engine/ai/doctrine-layout.mjs?v=48';
import { chooseMove, createMemory, observe, noteOwnMove } from '../engine/ai/ai.mjs?v=48';
import { searchMove } from '../engine/ai/search.mjs?v=48';
