...
import { SEATS } from '../engine/src/board.mjs?v=201';
import { legalMoves as calcLegalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=201';
import { GAME_WS } from './config.js?v=201';
import { ensureAccount } from './account.js?v=201';
