...
import { SEATS } from '../engine/src/board.mjs?v=202';
import { legalMoves as calcLegalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=202';
import { GAME_WS } from './config.js?v=202';
import { ensureAccount } from './account.js?v=202';
