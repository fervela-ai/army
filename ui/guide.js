...
import { buildBasicsTour } from './guide-demo.js?v=214';
...
<h3>敵方司令死了之後，你的軍長就更敢動</h3>
<p>敵方司令陣亡是公開的（他的軍旗會亮出來）。<b>那一家</b>剩下的棋子裡，
能吃掉你軍長的只剩炸彈和地雷；碰到對方的軍長是同歸於盡。
但<b>另一家敵人的司令還在</b>——往那邊推進時，你的軍長仍然會死。
所以這條的用法是：先去吃「已經確定不是炸彈」的子，而不是橫著走。</p>
<p><b>怎麼算確定不是炸彈？</b>炸彈碰到誰都同歸於盡，所以
<b>凡是吃掉別人還活著的棋子，一定不是炸彈</b>。</p>

<h3>師長是很好的探子</h3>
<p>比師長大的只有司令和軍長，另外炸彈和地雷會跟它同歸於盡或吃掉它，
碰到對方的師長則是同歸於盡。所以<b>師長死掉時，你會得到很精確的情報</b>——
那一格不是大子就是雷或彈。而且師長換掉一顆炸彈，等於保住了你的司令和軍長。</p>

<h3>行營是關鍵據點</h3>
<p><b>軍旗前面的行營盡量別讓敵人站進去。</b>你的後兩排要「假裝是地雷」不能亂動，
...
<h3>記住哪一格吃過你的子</h3>
<p>被吃的位置是情報。同一格連續吃掉你兩顆棋，那裡多半是大子或地雷——
<b>別再送第三顆過去</b>，要嘛換工兵去測（地雷只有工兵拆得掉），要嘛用炸彈換。</p>`,
  },
  {
    id: 'setup', label: '基礎佈陣',
    html: `
...
<h3>陣型會決定勝負</h3>
<p>我們自己跑過一輪模擬：<b>讓同一個電腦對手，用有章法的陣型去打亂數擺的陣型，前者贏了大部分的局</b>。
這只是電腦互打的結果，不代表人類對局的勝率，但足以說明一件事——<b>佈陣的影響比想像中大得多</b>。</p>
