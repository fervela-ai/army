...
import { SEATS } from '../engine/src/board.mjs?v=191';
import { legalMoves as calcLegalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=191';
import { GAME_WS } from './config.js?v=191';
import { ensureAccount } from './account.js?v=191';
