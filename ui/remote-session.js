...
import { SEATS } from '../engine/src/board.mjs?v=208';
import { legalMoves as calcLegalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=208';
import { GAME_WS } from './config.js?v=208';
import { ensureAccount } from './account.js?v=208';
