...
import { localSession } from './session.js?v=187';
import { remoteSession } from './remote-session.js?v=187';
import { createRoom, ensureAccount, currentAccount, redeem, rotateRecovery } from './account.js?v=187';
import { RECORD_ENDPOINT, AI_VERSION } from './config.js?v=187';
import { buildGuide } from './guide.js?v=187';
import { checkAchievements, ACHIEVEMENTS, unlockedIds, titleFor, noteGame } from './achievements.js?v=187';
import { createBoardView } from './board.js?v=187';
import { SFX, setEnabled, VARIANTS, getChoice, setVariant, preview } from './sound.js?v=187';
...
// 值從自己的 import URL 取（?v=187），bump-ui-version.sh 一改就跟著動，不會忘記同步。
