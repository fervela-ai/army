...
import { SEATS } from '../engine/src/board.mjs?v=207';
import { legalMoves as calcLegalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=207';
import { GAME_WS } from './config.js?v=207';
import { ensureAccount } from './account.js?v=207';
