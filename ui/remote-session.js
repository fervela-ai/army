...
import { legalMoves as calcLegalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=186';
import { GAME_WS } from './config.js?v=186';
import { ensureAccount } from './account.js?v=186';
