...
import { legalMoves as calcLegalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=185';
import { GAME_WS } from './config.js?v=185';
import { ensureAccount } from './account.js?v=185';
