...
import { SEATS, TEAM_OF } from '../engine/src/board.mjs?v=141';
import { legalMoves, validateSetup, movePath } from '../engine/src/rules.mjs?v=141';
import {
  createRoom, join, claimSeat, startSetup, submitLayout, maybeStartGame,
  play, stateForPlayer,
} from '../engine/src/room.mjs?v=141';
import { doctrineLayout } from '../engine/ai/doctrine-layout.mjs?v=141';
import { VALUE } from '../engine/ai/lookahead.mjs?v=141';
import { chooseMove, createMemory, observe, noteOwnMove } from '../engine/ai/ai.mjs?v=141';
import { searchMove } from '../engine/ai/search.mjs?v=141';
